...
<main>
    ...
    @method('PUT')
        <div class="row justify-content-around">
            <div class="left" >
                <div class="form-group" style="border: solid; border-color: #000000;height:380px;padding: 30px 60px;">
                    <label for="photo" class="form-label">POST PHOTO</label>
                    <img src="{{asset('storage/'.$post['photo']) }}" width="180px">
            ...
            <div class="right">
                <div class="" style="border: solid; border-color: #000000;padding: 30px 60px;">
                    ...
                    <div class="form-group">
                        ...
                        <select class="season-form-select" aria-label="Default select example" name="season" value="{{ $post->season }}">
                    ...
                    <div class="form-group">
                        ...
                        <select class="category-form-select" aria-label="Default select example" name="category"value="{{ $post->category }}" >
                    ...
                    <div class="form-group">
                        ...
                        <select class="size-form-select" aria-label="Default select example" name="size" value="{{ $post->size }}">
                    ...
                    <div class="form-group">
                        ...
                        <select class="color-form-select" aria-label="Default select example" name="color" value="{{ $post->color }}">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="comment" name="comment" rows="3" style="resize:none">{{$post->comment}}</textarea>
                    </div>
                </div>
